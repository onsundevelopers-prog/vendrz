    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-canvas px-5">
        <div className="text-center">
          ...
          <a href="/upload" className="mt-2 inline-block text-[13px] tracking-tight text-emerald-400 underline underline-offset-4">
            Upload a contract
          </a>
        </div>
      </main>
          ...
          {PIPELINE_STAGES.map((stage, i) => {
            ...
            return (
              ...
              >
                ...
                {isDone && !isFinal && (
                  <span className="ml-auto text-[11px] tracking-tight text-emerald-400/80">done</span>
                )}
                {isActive && (
                  <span className="ml-auto text-[11px] tracking-tight text-emerald-400">
