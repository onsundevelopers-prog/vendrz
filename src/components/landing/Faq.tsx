...
const FAQS = [
  ...
  },
  {
    ...
    a: "It's optional and read-only. Connect it from the dashboard (never during signup) and Watchtower proposes contract-looking emails and attachments for you to review. Nothing is imported until you explicitly select it, and you can disconnect anytime.",
  },
];
