...
function ApprovalCard({
  ...
  return (
    <div className="mt-2.5 border-t border-line pt-2.5">
      <p className="flex items-center gap-1.5 text-[10.5px] font-semibold uppercase tracking-[0.1em] text-muted/70">
        <Mail size={10} />
      ...
      >
        ...
        {messages.length === 0 && (
          <div className="shrink-0 border-t border-line px-3 py-2.5">
            <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.1em] text-muted/60">
              Suggested
            </p>
